function [revealed_target_position,revealed_nonnan,target_position_log_idx]=DAG_get_revealed_target_positions(...
...
%    revealed_target_position_correct{a}(b{:})   =sum(target_position_log_idx{a} & previous_target_position_log_idx & revealed_targets_in_order(:,a)==1);
    ...
    if a<max_tar_revealed && ~calculate_only_first
        ...
        [revealed_target_position,revealed_nonnan,target_position_log_idx]=DAG_get_revealed_target_positions(...

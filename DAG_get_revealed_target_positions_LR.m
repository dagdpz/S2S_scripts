function [revealed_target_position,revealed_nonnan,target_position_log_idx]=DAG_get_revealed_target_positions_LR(...
...
for target_counter=[all_n_positions(position_log_idx) max(all_n_positions)+1]
    ...
    if a<max_tar_revealed
        ...
        [revealed_target_position,revealed_nonnan,target_position_log_idx]=DAG_get_revealed_target_positions_LR(...
